...
4
"""
# for location, name in ssafy.items():
#     print(len(name))
...
# if 'requests' in python standard library
...
# for values in ssafy['classes']['gj'].values():
#     print (values)
...
# # """
# import random
# lucky = random.sample((ssafy['classes']['dj']['groups']['D']),1)
# print(lucky)